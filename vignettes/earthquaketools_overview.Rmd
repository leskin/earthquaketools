...
annotations to the n_max largest earthquakes (by magnitude).  In the example below, the timeline above is enhanced to add 5 annotations, using the text from the LOCATION_NAME column.
